      ...
      <div className="modal-dialog" role="document">
        <div className="modal-content">
          <div className="modal-header">
            ...
            <h4 className="modal-title">License Information</h4>
          </div>
          <div className="modal-body">
            ...
            affiliated with Digital Extremes Ltd. in any way. <br />
            <br />
            ...
            debugging is to clear your cache. <br />
