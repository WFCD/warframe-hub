<template>
  <b-navbar toggleable="md" type="dark" variant="primary" fixed="top">
    ...
    <b-collapse is-nav id="nav_collapse">
      <b-navbar-nav>
        <b-nav-item><router-link to="/" exact><i class="fas fa-clock faIcon"></i> Timers</router-link></b-nav-item>

        

        <b-nav-item-dropdown left>
          <template slot="button-content"><i class="fas fa-globe faIcon"></i> Open World</template> 
        ...
        <b-nav-item-dropdown left>
          <template slot="button-content"><i class="fas fa-terminal faIcon"></i> Projects</template> 
      ...
      <b-navbar-nav class="ml-auto">
        <b-nav-item right href="https://discord.gg/jGZxH9f" target="_blank" v-b-tooltip.bottom title="Discord"><i class="fab fa-discord faIcon"></i></b-nav-item>
        <b-nav-item right v-b-modal.about-modal v-b-tooltip.bottom title="Information"><i class="fas fa-info faIcon"></i></b-nav-item>
        <b-nav-item right v-b-modal.settings-modal v-b-tooltip.bottom title="Settings"><i class="fas fa-cog faIcon"></i></b-nav-item>
      </b-navbar-nav>
