<template>
  <HubPanelWrap :title="headertext">
    <b-list-group>
      <b-list-group-item :style="styleObject" v-for="(acolyte, index) in acolytes"
        :key="acolyte.id"
        ...
        <span class="pull-left">
          <b>
            <i class="far fa-eye faIconStyle" v-b-tooltip :title="`${acolyte.agentType} Discovered`" :style="acolyteIcons" v-if="acolyte.isRequired"></i>
