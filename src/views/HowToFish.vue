  ...
  <b-container>
    <b-row class="text-center">
      ...
      <b-col md="8" offset="2">
        ...
        <p>From now on you should refer to the
          <router-link to="/fish">Super Fishing Reference Table</router-link>for whatever other information more specific on what/where/how to catch each fish. It contains EVERYTHING you need to know about them.
        </p>
        <br>
        <br>
        <h4>
        ...
        <p>
          ...
          pressing F (
          <del>to pay respects</del>to switch to your weapons).
        </p>
        <p>
        ...
        <p>Remember that Fish are completely client-based, which means that different players will see different fish on the same session.</p>
        <br>
        <br>
        <h4>
          <b>The catching mechanic! (This part is a bit complex so read carefully.)</b>
        </h4>
        <p>
        ...
        <p>
          In the
          <router-link to="/fish">Super Fishing Reference Table</router-link>,
        ...
        <p>
          ...
          <b>IN CLOSE PROXIMITY TO A HOTSPOT</b>, use the dye to see the fish better, and
