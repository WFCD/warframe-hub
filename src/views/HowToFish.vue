  ...
  <b-container fluid>
    <b-col md="8" offset="2">
      <div class="row text-center">
        ...
        <FishImg type="guide" item="clem" name="Map" height="100%" width="100%" />
        <br /><br />
        <p>
      ...
      <div class="row text-center">
        ...
        <div class="panel panel-primary">
          <div class="panel-heading">
            <h3 class="panel-title">Fishing Map <a href="#fishmap" data-toggle="collapse"><span class="glyphicon glyphicon-triangle-bottom pull-right"></span></a></h3>
          </div>
          <div class="panel-body collapse" id="fishmap">
      ...
      <div class="row text-center">
          ...
          <p>
              From now on you should refer to the <router-link to="/fish">Super Fishing Reference Table</router-link> for whatever other information more specific on what/where/how to catch each fish. It contains EVERYTHING you need to know about them.
          </p>
          <br><br>
          <h4><b>Now let's fish!</b></h4>
          <p>
            To catch some fish, switch to your spear by clicking it on your gear wheel, keep in mind that when you do so, your gear wheel will switch to the fishing wheel that contains your bait and dye (if you have them, probably not now), so the only way to unequip the spear is pressing F (<del>to pay respects</del> to switch to your weapons).
          </p>
          <p>
          ...
          <br><br>
          <h4><b>The catching mechanic! (This part is a bit complex so read carefully.) </b></h4>
          <p>
          ...
          <p>
            In the <router-link to="/fish">Super Fishing Reference Table</router-link>, the "Spear" column represents the spear that can capture the fish in 1 hit.
          </p>
          <p>
            Fishing is all about patience, so keep at it!
          </p>
          <br><br>
          <h4><b>Let's get better fish!</b></h4>
          <p>
          ...
          <h6 class="text-center">[Screenshot by --Q--Shin]</h6>
          <br />
          <p>All the water surface around this island can spawn "Hotspots", which is the next topic I will explain.</p><br />
          <br /><br />
          <h4><b>Hotspots</b></h4><br />
          <p>Hotspots are bubbly/wavy water that spawns at random in some locations, it looks like this:</p><br />
          <FishImg type="guide" item="guide3" height="100%" width="100%" /><br />

          <h6 class="text-center">[Image by Narration]</h6><br />
          <FishImg type="misc" item="hotspot" name="Hotspot" height="100%" width="100%" /><br />
          <h6 class="text-center">[Animated GIF by How4Much]</h6><br />
          <p>
          ...
          <p style="color:firebrick"><b>Keep in mind that even though larger fishes give more standing, they don't give extra unique drops,
              so it's recommended to get the drops (fillet) from the smaller ones, and save the larger fish for
                  standing. Unless you really need standing.</b></p>
          <br /><p>(Expect more info to be added to this guide in a later date.)</p>
          <br /><br />
          <p>
