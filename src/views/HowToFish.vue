  ...
  <b-container fluid>
    <b-col md="8" offset="2">
      <b-row class="text-center">
        <h2 class="text-center">How do Fish?</h2><br />
        <h3 class="text-center">The definitive guide to fishing in Warframe</h3><br />
        ...
        <br /><br />
        <p>Welcome, if you're here, you want to know how to fish, and what to do. So sit down and buckle up,
          because we're going on a ride. A grinding ride.</p>
        <br>
      ...
      <b-row>
        ...
        <p>
            From now on you should refer to the <router-link to="/fish">Super Fishing Reference Table</router-link>
            for whatever other information more specific on what/where/how to catch each fish. It contains EVERYTHING you need to know about them.
        </p>
        <br><br>
        ...
        <p>
          ...
          pressing F (<del>to pay respects</del> to switch to your weapons).
        </p>
        <p>
        ...
        <p>
          In the <router-link to="/fish">Super Fishing Reference Table</router-link>,
