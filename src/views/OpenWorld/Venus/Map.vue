...
export default {
  ...
  computed: {
    ...mapGetters('worldstate', { toggles: 'vallisMapToggles' }),
  },
  methods: {
    track() {
  ...
  mounted: function () {
    this.$nextTick(function () {
      ...
      this.map.on('overlayadd overlayremove', (e) => {
        this.toggles[e.name + '-toggle-value'] = e.type === 'overlayadd';
        this.$store.commit('worldstate/vallisMapToggles', [this.toggles]);
      });
    });
  },
};
