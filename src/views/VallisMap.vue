      ...
      <b-col>
        ...
        >
          ...
          >
            ...
            <l-geo-json
              :geojson="caves.toroidfishcave.json"
              :options="caves.toroidfishcave.opts"
            />
            <l-geo-json
              :geojson="caves.toroidcave.json"
              :options="caves.toroidcave.opts"
            />
          </l-layer-group>

          <l-layer-group layer-type="overlay" key="Toroids" name="Toroids">
            <l-marker :lat-lng="markers.calda.loc">
              <l-icon :icon-size="icons.calda.size" :icon-url="icons.calda.src">
              </l-icon>
              <l-tooltip
                :options="{
                  permanent: false,
            ...
            <l-marker :lat-lng="markers.sola.loc">
              <l-icon :icon-size="icons.sola.size" :icon-url="icons.sola.src">
              </l-icon>
              <l-tooltip
                :options="{
                  permanent: false,
            ...
            <l-marker :lat-lng="markers.vega.loc">
              <l-icon :icon-size="icons.vega.size" :icon-url="icons.vega.src">
              </l-icon>
              <l-tooltip
                :options="{
                  permanent: false,
